...
SECRET_KEY = 'django-insecure-42pn(qoqbw8jz3ibg!9m9qfq8+4-_^mvns%+f%j=1a@ej1#hkt'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, '..', 'C:\\Users\\User\\HotelManagement\\builder\\templates'), ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'HOST': 'localhost',  # Replace 'localhost' with your MySQL server host
        'PORT': '3306',  # Replace '3306' with your MySQL server port
        'OPTIONS': {
